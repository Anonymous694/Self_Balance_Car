...
#include "src/PID_v1.h" //From https://github.com/br3ttb/Arduino-PID-Library/blob/master/PID_v1.h
#include "src/MPU6050_6Axis_MotionApps20.h" //https://github.com/jrowberg/i2cdevlib/tree/master/Arduino/MPU6050
...
void setup() {
  ...
  // initialize device
    ...
    mpu.setZGyroOffset(294);
    mpu.setZAccelOffset(-2998); 
